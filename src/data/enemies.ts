...
export const ENEMIES: Record<string, Enemy> = {
  ...
  arrowgoyle: {
    id: 'arrowgoyle',
    name: 'アロー・ガーゴイル',
    ...ENEMY_SPRITES.arrowgoyle,
    maxHp: 85,
    attack: 14,
    categories: ['function', 'variable'],
    difficulty: [2, 3],
    exp: 70,
  },
  recursion: {
    id: 'recursion',
    name: 'さいきのまじん リカージョン',
    ...ENEMY_SPRITES.recursion,
    maxHp: 130,
    attack: 15,
    categories: ['function', 'condition'],
    difficulty: [1, 3],
    exp: 200,
    isBoss: true,
    recommendLevel: 8,
  ...
  kraken: {
    id: 'kraken',
    name: 'はいれつクラーケン',
    ...ENEMY_SPRITES.kraken,
    maxHp: 160,
    attack: 18,
    categories: ['array', 'function', 'loop'],
    difficulty: [2, 3],
    exp: 300,
    isBoss: true,
    recommendLevel: 10,
